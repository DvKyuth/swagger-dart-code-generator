...
RequestContent? _contentFromJson(Map<String, dynamic>? map) {
  ...
  if (map.containsKey('multipart/form-data') &&
    ...
    final requestContent = RequestContent(isMultipart: true, schema: SwaggerSchema.fromJson(multipart));
  ...
  if (map.containsKey('application/x-www-form-urlencoded') &&
    ...
    final requestContent = RequestContent(isUrlencoded: true, schema: SwaggerSchema.fromJson(multipart));
    return requestContent;
  }
